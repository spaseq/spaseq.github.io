...
############## ############## ############## ############## 
 ...
 where -q describe the query utilised for SCEP, -f describes the file used for the streams, -es describe the number of triples used within an event.
...
############## ############## ############## ############## 
The query folder contains the test queries for the SHD usecase. The stream folder contains the set of streams in .nt format and a stream file which describes the IRIs of each stream and their filepaths: this file is used to send the streams to the spaseq engine.
