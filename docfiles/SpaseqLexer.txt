...
//EVENTPATTERN : ('E'|'e')('V'|'v')('E'|'e')('N'|'n')('T'|'n')('P'|'p')('A'|'a')('T'|'t')('T'|'t');
...
////New Stuff//////
SEQUENCE : ('S'|'s')('E'|'e')('Q'|'q');
 ///ID : [a-zA-Z]+ ;

ESELECTION : ESTRATEGY;

 PATTYPE : SEQOPERATION;
 //EVENTPATT : ('E'|'e');//('V'|'v')('E'|'e')('N'|'n')('T'|'n')('P'|'p')('A'|'a')('T'|'t')('T'|'t');
